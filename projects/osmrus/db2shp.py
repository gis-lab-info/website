...
user='pgsql'
host='localhost'
regions=['adygeya','altay', 'altayskiy', 'amur', 'arkhan','astrakhan', 'bashkir', 'belgorod', 'bryansk', 'buryat'\
, 'vladimir', 'volgograd', 'vologda', 'voronezh', 'dagestan', 'evrey', 'aginsk', 'chita', 'ivanov', 'ingush', 'ustordyn', 'kabardin',\
'kalinin', 'kalmyk', 'kaluzh', 'kamch', 'karach', 'karel', 'kemerovo', 'kirov', 'komi', 'kostrom', 'krasnodar', 'krasnoyarsk', 'kurgan', 'kursk',\
'leningrad', 'lipetsk', 'magadan', 'mariyel', 'mordov', 'murmansk', 'nenec', 'nizhegorod', 'novgorod', 'novosib', 'omsk',\
'orenburg', 'orlovsk', 'penz', 'perm', 'prim', 'pskov', 'rostov', 'ryazan', 'samar', 'saratov', 'yakut', 'sakhalin', 'sverdl',\
